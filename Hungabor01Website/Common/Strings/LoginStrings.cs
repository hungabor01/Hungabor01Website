namespace Common.Strings
{
    ...
    {
        public const string LoginBuiltIn = "Built-in login.";
        public const string LoginExternal = "{0} login.";

        public const string InvalidLogin = "Invalid login attempt.";
        public const string LoginUsernameError = "Wrong username or email.";
        public const string LoginPasswordError = "Wrong password.";
